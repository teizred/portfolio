    ...
    return (
        <main>
            ...
            <button
                ...
                className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-3 rounded-full border border-white text-white hover:bg-white hover:text-black transition-all duration-300 z-20 font-montserrat text-sm tracking-widest uppercase"
            >
                Continuez →
            </button>
        </section>
